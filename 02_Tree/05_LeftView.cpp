 ...
 */
 ...
 //--------------Function to help to finding the left view of binary tree
 void solve(Node* &root,map<int,int> &mp,int lvl){
     //ase case
     if(!root) return ;
     
     if(mp.find(lvl) == mp.end()) mp[lvl] = root->data;
